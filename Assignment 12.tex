...
Find the coordinate matrix of the vector \myvec{1&0&1} in the basis of $C^{3}$ consisting of the vectors \myvec{2i&1&0} , \myvec{2&-1&1} , \myvec{0&1+i&1-i} in that order.
\section{Solution}
consider
\begin{align}
